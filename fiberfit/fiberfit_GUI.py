...
class Ui_MainWindow(object):
  ...
  #       self.midGrid.addItem(spacerItem4, 0, 9, 1, 1)
        ...
        self.clearButton.setMinimumSize(QtCore.QSize(60, 50))
        self.clearButton.setMaximumSize(QtCore.QSize(60, 50))
        ...
        self.exportButton.setMinimumSize(QtCore.QSize(60, 50))
        self.exportButton.setMaximumSize(QtCore.QSize(60, 50))
        ...
        self.loadButton.setMinimumSize(QtCore.QSize(60, 50))
        self.loadButton.setMaximumSize(QtCore.QSize(60, 50))
        ...
        self.startButton.setMinimumSize(QtCore.QSize(60, 50))
        self.startButton.setMaximumSize(QtCore.QSize(60, 50))
        ...
        self.settingsButton.setMinimumSize(QtCore.QSize(60, 50))
        self.settingsButton.setMaximumSize(QtCore.QSize(60, 50))
